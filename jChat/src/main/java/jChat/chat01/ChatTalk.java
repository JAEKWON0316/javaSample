...
public class ChatTalk extends HttpServlet {
	...
	//채팅메세지가 몇개 까지 나올지 기본셋팅
	public void init() { //초기 서블릿 세팅
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
      res.setContentType("text/html;charset=utf-8");
       ...
       out.println("<link rel=\'stylesheet\' href=\'https://cdnjs.cloudflare.com/ajax/libs/remixicon/4.2.0/remixicon.css\' integrity=\'sha512-OQDNdI5rpnZ0BRhhJc+btbbtnxaj+LdQFeh0V9/igiEPDiWE2fG+ZsXl0JEH+bjXKPJ3zcXqNyP4/F/NegVdZg==\' crossorigin=\'anonymous\' referrerpolicy=\'no-referrer\' />");
       ...
       while(true) {
    	       ...
    	       out.println("<li class='cbox'>"+message[i]+"</li>");
   ...
   protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	  ...
	  if(msg != null &&  msg.trim().length() != 0) { //trim은공백제거 즉 공백제거하고 나음 길이가 0이 아니면
		  synchronized(message) {
